...
const ForgotPassword = () => {
  ...
  useScrollTop();
  useDocumentTitle('Olvidaste contraseña | STL Premium');
  useEffect(() => {
    if (didMount) {
  ...
  return (
    <div className="forgot_password">
      ...
      <h2>¿Olvidaste tu constraseña?</h2>
      <p>Ingresá tu contraseña y te enviaremos un email para resetear tu contraseña.</p>
      <br />
      <input
        field="email"
        required
